    ...
    <>
      <button
        ...
        style={{
          ...
          boxShadow: '0 6px 24px rgba(30,58,95,0.35)',
        }}
      >{open ? '✕' : 'AI'}</button>
        ...
        {open && (
          <motion.div
            ...
            style={{
              ...
              height: 480, background: '#fff', border: '1px solid var(--border)', zIndex: 60,
              display: 'flex', flexDirection: 'column', boxShadow: '0 10px 40px rgba(0,0,0,0.15)',
            }}
          >
            <div style={{ background: 'var(--navy)', color: '#fff', padding: '14px 18px', fontFamily: 'var(--font-display)' }}>
              ArtMind Concierge
            </div>
            <div style={{ flex: 1, overflowY: 'auto', padding: 16, display: 'flex', flexDirection: 'column', gap: 10 }}>
              {messages.map((m, i) => (
                <div key={i} style={{
                  ...
                  background: m.role === 'user' ? 'var(--navy)' : 'var(--light-gray)',
                  color: m.role === 'user' ? '#fff' : 'var(--dark-gray)',
            ...
            <div style={{ display: 'flex', borderTop: '1px solid var(--border)' }}>
              <input
                ...
                style={{ flex: 1, border: 'none', padding: '14px', fontFamily: 'var(--font-body)', outline: 'none' }}
              />
